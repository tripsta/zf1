...
defined('TESTS_ZEND_CACHE_REDISCLUSTER_HOST') || define('TESTS_ZEND_CACHE_REDISCLUSTER_HOST', '127.0.0.1');
defined('TESTS_ZEND_CACHE_REDISCLUSTER_PORT') || define('TESTS_ZEND_CACHE_REDISCLUSTER_PORT', 30001);
